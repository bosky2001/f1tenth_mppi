...
class MPPIPlanner(Node):
    def __init__(self):
        ...
        self.waypoint_path = "/home/nvidia/f1tenth_ws/src/f1tenth_mppi/trajectories/levine_1.csv"
        ...
        self.config = Config()
        self.config.load_file("/home/nvidia/f1tenth_ws/src/f1tenth_mppi/config/config.yaml")
        ...
        self.pose_sub_ = self.create_subscription(PoseStamped if self.on_car else Odometry, pose_topic, self.pose_callback, qos_profile=qos_profile)
